...
Текущая предметная схема хранит вакансии, отклики и последовательный журнал событий отклика. Создание намерения отправки и события `APPLY_INTENT` выполняется в одной транзакции.
