...
DEFAULT_COVER_LETTER_PROMPT = (
    "Пиши 2–3 коротких абзаца общим объёмом 450–900 знаков. "
    "Сразу после «Здравствуйте!» свяжи одно подтверждённое действие кандидата "
    "с основной задачей вакансии. Затем приведи ещё один конкретный близкий пример. "
    ...
    "Выбирай один наиболее близкий к задачам вакансии пример. Добавляй второй только тогда, "
    "когда он подтверждает другое существенное требование вакансии; если есть подтверждённый "
    "backend-опыт, не заменяй его примером из анализа данных или другой отрасли. "
    "Если в подтверждённых фактах нет обязательной технологии, не упоминай её и не извиняйся."
)
