...
DEFAULT_COVER_LETTER_PROMPT = (
    ...
    "Выбирай только два наиболее близких к задачам вакансии примера: если есть "
    "подтверждённый backend-опыт, не заменяй его примером из анализа данных или другой отрасли. "
